...
namespace EachOneMatters.Gameplay.PlayerUnits
{
    public class PoliceOfficer : MonoBehaviour, IUnitState
    {
        ...
        public void SetPoliceOfficerActive(BulletPool bulletPool, ChunkPool chunkPool,
        ...
        {
            _unitAnimation.MoveWinAnimation();
            _weapon.StopShooting();
        }

        public void SetSpeed(float backwardMovementSpeed)
        {
            _unitAnimation.MoveRunAnimation(true);
        ...
        private void SubscribeAndHandleBaseDetection()
        {
            switch (_currentState)
            {
                ...
                case ProgressionState.BaseEntryCompleted:
                    _officerMovement.StopMoving();
                    _unitAnimation.MoveRunAnimation(false);
        ...
        {
            _officerMovement.StopMoving();
            _unitAnimation.MoveFallingAnimation();
            OnPoliceDeath?.Invoke(this);

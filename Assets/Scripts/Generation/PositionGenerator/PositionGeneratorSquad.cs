        ...
        public Vector3 CreateNextSpawnPosition()
        {
            switch (_currentState)
            {
                ...
                case SquadFormationPhase.ExpandingRadius:
                    _countRings++;
                    _nextPositionSpawn = new Vector3(_positionSpawnPoliceOfficer.localPosition.x - (_xStepOffset * _countRings), _nextPositionSpawn.y, _positionSpawnPoliceOfficer.localPosition.z);
                ...
                case SquadFormationPhase.MovingUpRight:
                    _numberRings++;
                    _nextPositionSpawn = new Vector3(_lastPositionPoliceOfficerSpawn.x + _xRowOffset, _nextPositionSpawn.y, _lastPositionPoliceOfficerSpawn.z + _zStepOffset);
                ...
                case SquadFormationPhase.MovingRight:
                    _numberRings++;
                    _nextPositionSpawn = new Vector3(_lastPositionPoliceOfficerSpawn.x + _xStepOffset, _nextPositionSpawn.y, _lastPositionPoliceOfficerSpawn.z);

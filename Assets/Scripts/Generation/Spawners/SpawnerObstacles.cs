...
using EachOneMatters.Generation.Obstacle;
using UnityEngine;
...
namespace EachOneMatters.Generation.Spawners
{
    public class SpawnerObstacles : MonoBehaviour
    {
        ...
        {
            positionRotatingBlade = new Vector3(positionRotatingBlade.x, _verticalPositionRotatingBlade,
                positionRotatingBlade.z);
        ...
        {
            positionSpikedCylinder = new Vector3(positionSpikedCylinder.x, _verticalPositionRotatingBlade,
                positionSpikedCylinder.z);

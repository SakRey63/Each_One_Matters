        ...
        private Vector3 GetPositionOnBase(Vector3 startPositionToBase)
        {
            switch (_currentPhase)
            {
                ...
                case SquadFormationPhase.MovingRight:
                    _lastPositionToBaseRight = new Vector3(_lastPositionToBaseRight.x, _lastPositionToBaseRight.y, _lastPositionToBaseRight.z + _stepOffset); _nexPositionSpawn = _lastPositionToBaseRight;
                    _currentPhase = SquadFormationPhase.MovingLeft;
                    break;

                case SquadFormationPhase.MovingLeft:
                    _lastPositionToBaseLeft = new Vector3(_lastPositionToBaseLeft.x, _lastPositionToBaseLeft.y, _lastPositionToBaseLeft.z - _stepOffset); _nexPositionSpawn = _lastPositionToBaseLeft;
                    _currentPhase = SquadFormationPhase.MovingRight;
                    break;
            }

...
using EachOneMatters.Gameplay.Ocean;
    ...
    public class GameSessionSystem : MonoBehaviour
    {
        ...
        private void HandleCallHelpPolice()
        {
            ...
            if (_scoreHandler.CurrentScore >= _progressSystem.GetCallHelpPrice())
            {
                ...
                int spawnCount = Mathf.Min(YG2.saves.gameplay.CountHelpPoliceOfficer, YG2.saves.player.MaxPoliceCount - _player.PoliceCount);
